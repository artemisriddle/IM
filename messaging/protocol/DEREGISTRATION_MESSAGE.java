 ...
 * created: 9/26/2015
 *
 * DEREGISTRATION_MESSAGE.java: client deregistration message.
...
public class DEREGISTRATION_MESSAGE {
    ...
    //for unmarshalling
    public DEREGISTRATION_MESSAGE(byte[] marshalledBytes) throws IOException {
    ...
    public DEREGISTRATION_MESSAGE(String user_id, byte[] ip_address, int port){
        //Five is the messageID for a deregistration message
